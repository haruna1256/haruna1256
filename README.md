<h1 align="center">こんにちは、川岸遥奈です 🐾</h1>
...
### [Rihlar](https://github.com/Rihlar/rihlar_front)
- **概要**: 現実世界での移動や滞在行動をゲーム化する陣取り型ライフログアプリ
...
### [Slidekit](https://github.com/haruna1256/SlideKitAtelier)
- **期間**: 2025年9月30日 〜 2025年2月5日
- **内容**: swiftでプレゼン資料を作成する
- **成果**: swiftでプレゼン資料を作ることによって、どういう処理が必要なのかまたosが違うとどういった違いがあるのか研究
